    ...
    <div className="min-h-screen flex">
      ...
      <div className={["relative max-w-sm w-full md:w-72 flex flex-col flex-shrink-0 z-40", colors.bgNav].join(' ')}>
        <div class="absolute top-0 right-0 m-1">
          <button onClick={() => setMode(mode === 'dark' ? 'light' : 'dark')} className="flex items-center justify-center h-12 w-12 rounded-full focus:outline-none focus:bg-gray-600" aria-label="Close sidebar">
